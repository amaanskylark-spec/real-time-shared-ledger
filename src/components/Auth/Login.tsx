...
export const Login: React.FC<LoginProps> = ({ onToggleMode, initialMessage = '', initialUsername = '' }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-4">
      ...
      <div className="relative bg-slate-800/80 backdrop-blur-xl border border-slate-700/50 rounded-3xl shadow-2xl w-full max-w-md p-8">
        ...
        {message && (
          <div className="bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 px-4 py-3 rounded-xl mb-5 text-sm">
            {message}
          </div>
        )}
