...
export const Login: React.FC<LoginProps> = ({ onToggleMode, initialMessage = '', initialEmail = '' }) => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">Sign in to track shared expenses in real time</p>
        </div>
        ...
        <div className="mb-6 p-4 bg-yellow-50 border-2 border-yellow-200 rounded-xl">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm font-bold text-yellow-800 mb-1">Test Credentials</p>
              <p className="text-xs text-yellow-700 font-mono">Email: <span className="font-bold">test@example.com</span></p>
              <p className="text-xs text-yellow-700 font-mono">Password: <span className="font-bold">test123</span></p>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <div className="mt-2 flex items-center justify-between gap-3">
              <p className="text-xs text-gray-500">Use the same email you registered with.</p>
              <button
                type="button"
